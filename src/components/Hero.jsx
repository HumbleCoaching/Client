...
function Hero() {
  return (
    <section className="h-screen flex flex-col items-center md:flex-row md:justify-between transition-all ">
        ...
        <div className="right flex max-w-1/2 p-4">
            <img src="https://img.freepik.com/free-vector/isometric-soft-skills-concept-icon-with-three-characters-listening-their-mentor_1284-63039.jpg?w=740&t=st=1696941746~exp=1696942346~hmac=9418a5b4523388a8e3300d4050a06c271a708b21af7e914f8b8e1e3b6a2671ace" alt="" />
        </div>
    </section>
  )
}
